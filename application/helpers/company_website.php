<?php
  ...
  */
  ...
  //NIMROD'S EDIT:
  //Peace of Mind LLC links of company members only:
  define('DASHBOARD_TAB_POM_LINKS', 'pom_links');
  ...
  */
  function dashboard_tabbed_navigation($selected = DASHBOARD_TAB_OVERVIEW) {
	...
	//NIMROD'S EDIT: ADDED PEACE OF MIND,LLC LINKS TAB IF USER IS A MEMBER OF OWNER COMPANY ******************
	if (logged_user()->isMemberOfOwnerCompany()) {
		add_tabbed_navigation_item(
		  DASHBOARD_TAB_POM_LINKS,
		  'Peace Of Mind Links',
		  get_url('dashboard', 'pom_links')
		);
	}
