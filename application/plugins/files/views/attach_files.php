...
<script type="text/javascript" src="<?php echo get_javascript_url('yui/yahoo/yahoo-min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_javascript_url('yui/dom/dom-min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_javascript_url('yui/event/event-min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_javascript_url('yui/animation/animation-min.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_javascript_url('app.js') ?>"></script>
<script type="text/javascript" src="<?php echo get_javascript_url('widgets/UserBoxMenu/widget.js') ?>"></script>
