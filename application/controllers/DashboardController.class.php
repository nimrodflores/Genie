  ...
  class DashboardController extends ApplicationController {
    ...
    */
    function index() {
	  ...
	  $finished_projects = $logged_user->getFinishedProjects();
      $activity_log = null;
	  ...
	  // NIMROD's EDIT: INCLUDE FINISHED PROJECTS IN DASHBOARD INDEX SIDEBAR *******************************
    ...
    */
	...
	//NIMROD'S EDIT: ADDED PEACE OF MIND, LLC LINKS TAB
    function pom_links() {
