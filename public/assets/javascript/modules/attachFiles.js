App.modules.attachFiles = {
  ...
  buildSet : function(set_id) {
	...
	add_button.setAttribute('style', 'float:left;');
	add_button.setAttribute('id', 'add_file_button');
	...
	node = document.getElementById(App.modules.attachFiles.getSetControlId(set_id));	
	node.parentNode.insertBefore(add_button, node.nextSibling);
  },
  ...
  addControl : function(set_id) {
	...
	control_div.setAttribute('style', 'margin-top: 10px;');
	...
	remove_button.setAttribute('style', 'margin-top:0; float:none;');
	...
	container = App.modules.attachFiles.getSetControlsDivId(set_id);
	container_div = document.getElementById(container);	
	
	add_file_button = document.getElementById('add_file_button');	
	container_div.insertBefore(control_div, add_file_button);
